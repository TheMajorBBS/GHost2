    ...
    public class ProcessUtils
    {
        ...
        public static string ProductVersionOfCallingAssembly
        {
            get
            {
                ...
                return V.Major.ToString() + "." + StringUtils.PadLeft(V.Minor.ToString(), '0', 2) + "." + StringUtils.PadLeft(V.Build.ToString(), '0', 2);
            }
        }
        ...
        public static string ProductCopyright
        {
            get
            {
                FileVersionInfo v = FileVersionInfo.GetVersionInfo(Assembly.GetEntryAssembly().Location);
                return v.LegalCopyright;
            }
        }
